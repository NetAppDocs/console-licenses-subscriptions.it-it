...
summary: 'Gestisci i tuoi abbonamenti Keystone nella console NetApp abilitando gli abbonamenti per l"uso con Cloud Volumes ONTAP e richiedendo modifiche alla capacità impegnata per i livelli di servizio del tuo abbonamento.  Richiedendo capacità aggiuntiva per un livello di servizio si ottiene più spazio di archiviazione per i sistemi Cloud Volumes ONTAP .' 
---
...
[role="lead"]
Gestisci i tuoi abbonamenti Keystone nella console NetApp abilitando gli abbonamenti per l'uso con Cloud Volumes ONTAP e richiedendo modifiche alla capacità impegnata per i livelli di servizio del tuo abbonamento.  Richiedendo capacità aggiuntiva per un livello di servizio si ottiene più spazio di archiviazione per i sistemi Cloud Volumes ONTAP .
...
. Dal menu NetApp Console, selezionare *Governance > Licenze e abbonamenti*.
. Seleziona *Abbonamenti Keystone *.
. Per l'abbonamento di cui si desidera regolare la capacità, fare clic suimage:icon-action.png["Un'icona composta da tre punti affiancati"] e seleziona *Visualizza dettagli e modifica*.
