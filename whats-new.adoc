...
Per maggiori informazioni, vedere illink:https://docs.netapp.com/us-en/console/concept-billing-preferences.html["Documentazione sulle preferenze di fatturazione"] .
