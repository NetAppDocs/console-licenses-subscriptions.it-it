...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-convert-node-capacity.html["Convertire le licenze basate sui nodi in licenze basate sulla capacità"^]
