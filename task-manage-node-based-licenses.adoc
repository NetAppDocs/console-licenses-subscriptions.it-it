...
summary: Gestisci le licenze basate sui nodi nella NetApp Console per assicurarti che ogni sistema Cloud Volumes ONTAP disponga di una licenza valida con la capacità richiesta. 
---
