...
[role="lead lead"]
Gestisci le tue licenze basate sulla capacità dalla console NetApp per assicurarti che il tuo account NetApp disponga di capacità sufficiente per i tuoi sistemi Cloud Volumes ONTAP .

Le _licenze basate sulla capacità_ consentono di pagare Cloud Volumes ONTAP per TiB di capacità.

È possibile gestire le licenze Cloud Volumes ONTAP basate sulla capacità dalla console NetApp .
...
== Come vengono aggiunte le licenze alla console NetApp
