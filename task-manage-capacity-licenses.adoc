...
+
Per comprendere meglio le capacità visualizzate per il pacchetto Essentials, dovresti conoscere come funziona la fatturazione https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-licensing.html#notes-about-charging["Scopri come addebitare il pacchetto Essentials"^].
...
* Se vuoi fatturare la capacità di Cloud Volumes ONTAP tramite l'abbonamento autonomo Cloud Volumes ONTAP su AWS marketplace, il sistema Cloud Volumes ONTAP deve utilizzare un pacchetto supportato basato sulla capacità (Essentials o Freemium). Il pacchetto Professional non è supportato per l'inserzione autonoma e continua a essere fatturato tramite l'abbonamento NIS. Dopo aver selezionato il pacchetto che vuoi, usa *Preferenze di fatturazione* in NetApp Console per scegliere l'abbonamento marketplace da usare per la fatturazione di Cloud Volumes ONTAP.
